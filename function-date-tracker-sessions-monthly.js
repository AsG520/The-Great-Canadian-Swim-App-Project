...
onAuthStateChanged(auth, async (user) => {
    ...
    function loadMonth(date) {
        ...
        // Store sessions for each day
        // Example: August has 31 spots
        let dailySessions = new Array(numberOfDays).fill(0);
        ...
        snapshot.forEach((activityDoc) => {
            ...
            if (activityDate >= startOfMonth && activityDate <= endOfMonth) {
                ...
                // Array starts at 0, so subtract 1
                dailySessions[dayNumber - 1] += sessions;
            }
        });
